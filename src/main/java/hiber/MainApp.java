...
//      userService.add(new User("User4", "Lastname4", "user4@mail.ru", new Car("Honda", 1)));
...
//         System.out.println();
//      }
//      System.out.println("---------------Users by car-----------------");
//
      List<User> usersByCar = userService.getUserByCar("User1", 2);
      System.out.println(usersByCar);
